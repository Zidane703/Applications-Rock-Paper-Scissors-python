...
#Return tidak hanya mengirim balik nilai return ke pemanggil, namun juga menghentikan function. 
# Ini berarti, apapun yang tertulis setelah return pada function tidak akan di jalankan.